  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">Simple & General Collective Intelligence Engine</span>
          ...
          <div class="hero-desc">
            <p>
              Even with just a paragraph of text, <span class="highlight-bold">MiroFish</span> can automatically generate up to <span class="highlight-orange">millions of Agents</span> forming a parallel world. Inject variables from a god's-eye view, seeking <span class="highlight-code">“局部最优解”</span>
            </p>
            <p class="slogan-text">
              Let the future rehearse among Agent clusters, let decisions prevail after countless battles<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Avg $5/run for standard simulation</div>
            </div>
            <div class="metric-card">
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parse prediction needs & dynamic temporal memory update</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any entity in the simulated world & chat with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction needs in natural language (e.g..If Wuhan University releases an announcement revoking a disciplinary decision, what public opinion trends would follow?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Computed properties:Whether submission is allowed
...
// Start Simulation - Navigate immediately, APIcall inProcesspage to perform
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate toProcesspage (using special identifier for new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  /* 
    ...
    make sure imported in index.html import these Google Fonts 
  */
