...
This script reads parameters from a configuration file to run the simulation, enabling full automation
...
class IPCHandler:
    ...
    async def handle_batch_interview(self, command_id: str, interviews: List[Dict]) -> bool:
        ...
        try:
            ...
            actions = {}
            agent_prompts = {}  # Record the prompt for each agent
...
async def main():
    ...
    # Create the shutdown event at the start of the main function
    ...
    # Initialize log configuration (using fixed filenames, cleaning up old logs)
...
def setup_signal_handlers():
    ...
    Allow the program to properly clean up resources (close database, environment, etc.)
    """
