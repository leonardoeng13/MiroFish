...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This usage is required by the Zep SDK; warnings come from dynamic class creation and can be safely ignored
        ...
        def safe_attr_name(attr_name: str) -> str:
            """Convert a reserved name to a safe attribute name"""
