...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        # Return in "agent_name: activity_description" format without simulation prefix
    ...
    def _describe_create_comment(self) -> str:
        """Create a comment - includes comment content and post info"""
        content = self.action_args.get("content", "")
        post_content = self.action_args.get("post_content", "")
        post_author = self.action_args.get("post_author_name", "")
...
class ZepGraphMemoryUpdater:
    ...
    Monitors simulation action log files and updates new agent activities into the Zep knowledge graph in real time.
    Groups by platform; sends a batch to Zep after accumulating BATCH_SIZE activities per platform.
    ...
    # Send interval (seconds) to avoid sending requests too fast
    SEND_INTERVAL = 0.5
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        Args:
            ...
            api_key: Zep API Key (optional, defaults to value from config)
        """
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args will contain full context info (e.g., post content, username, etc.).
                ...
                try:
                    ...
                    with self._buffer_lock:
                        ...
                        if len(self._platform_buffers[platform]) >= self.BATCH_SIZE:
                            ...
                            # Send interval to avoid too many requests
    ...
    def _send_batch_activities(self, activities: List[AgentActivity], platform: str):
        """
        Batch send activities to the Zep knowledge graph (merged into a single text).
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "failed_count": self._failed_count,          # Failed batch send count
