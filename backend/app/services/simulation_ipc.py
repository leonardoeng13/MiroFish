    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None: In dual-platform simulation interviews both platforms; in single-platform simulation interviews that platform
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                ...
                - None: In dual-platform simulation each Agent interviews both platforms
            timeout: Timeout duration
