...
class InsightForgeResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            f"## Future Forecast Deep Analysis",
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                # Filter out garbage content with question numbers (Q1-9)
                skip = False
                for d in '123456789':
                ...
                if skip:
                    continue
                # Truncate overly long content (by sentence, not hard cut)
...
class InterviewResult:
    ...
    def to_text(self) -> str:
        """Convert to detailed text format for LLM understanding and report citations"""
        text_parts = [
...
class ZepToolsService:
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Fetches all graph edges, then filters for those related to the specified node
    ...
    def get_simulation_context(
        ...
        Args:
            ...
            limit: Limit on the number of results per category
    ...
    def insight_forge(
        ...
        3. Extracts relevant entities and gets their detailed info
        ...
        # Step 3: Extract relevant entity UUIDs from edges, only fetch those entities (not all nodes)
        entity_uuids = set()
        ...
        # Get details for all relevant entities (no limit, full output)
        entity_insights = []
    ...
    def _generate_sub_queries(
        ...
        Decomposes complex questions into multiple independently searchable sub-questions
        """
...
Return a JSON-formatted list of sub-questions."""
    ...
    def panorama_search(
        ...
        Gets a full view including all related content and historical/expired info:
        1. Get all related nodes
        2. Get all edges (including expired/invalid ones)
        3. Categorize current active and historical info
        
        This tool is suitable for scenarios that need a full picture of events and tracking evolution.
    ...
    def interview_agents(
        ...
        - Need to get real Agent responses (not LLM simulations)
        ...
        if not profiles:
            logger.warning(f"No profile file found for simulation {simulation_id}")
        ...
        # Step 4: Call the real interview API (no platform specified, defaults to both platforms simultaneously)
        try:
            ...
            # Step 5: Parse API result, construct AgentInterview objects
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                clean_text = re.sub('\u95ee\u9898\\d+[：:]\\s*', '', clean_text)
    ...
    def _load_agent_profiles(self, simulation_id: str) -> List[Dict[str, Any]]:
        ...
        # Prefer to try reading Reddit JSON format first
    ...
    def _select_agents_for_interview(
        ...
        system_prompt = """You are a professional interview planning expert. Your task is to select the most suitable interviewees from the simulated Agent list based on the interview requirements.
...
6. Ask directly, without background descriptions or prefixes
...
2. Identify consensus and disagreements among the viewpoints
3. Highlight valuable quotes
4. Objective and neutral, without favoring any side
...
- You may use **bold** to mark keywords, but avoid other Markdown syntax"""
